...
from api.routers import opportunity, inbox, profile, agent, get_status, settings, system as system_router
...
app.include_router(system_router.upgrade.router, prefix="/api")
