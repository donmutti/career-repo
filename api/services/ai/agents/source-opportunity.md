...
- When applying dealbreakers: judge the actual work context, not the employer's legal entity. IT consulting/outsourcing firms are not a dealbreaker when the role is embedded at a technical or financial end client — score against the end client's domain. "Squad Lead" and similar European titles are not people-management flags when the JD is technically substantive.
